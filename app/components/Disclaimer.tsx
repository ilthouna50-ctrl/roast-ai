...
export default function Disclaimer({ onAccept }: DisclaimerProps) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95">
            ...
            <div className="relative mx-4 w-full max-w-lg overflow-hidden rounded-[2rem] border border-white/10 bg-[#070707]/95 p-6 text-center shadow-[0_40px_120px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:p-8">
                <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full border border-red-500/25 bg-white/5">
                    <AlertTriangle className="h-12 w-12 text-red-400" />
                </div>

                <h2 className="mb-4 text-3xl font-semibold leading-tight text-white sm:text-4xl">Before You Continue</h2>
